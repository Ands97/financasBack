...
exports.getCategoryId = exports.deleteCategory = exports.updateCategory = exports.getCategories = exports.create = void 0;
const categoryModel_1 = __importDefault(require("../models/categoryModel"));
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newAccount = yield categoryModel_1.default.create({ category: req.body.title, userId: req.userId });
        res.json(newAccount);
    }
    catch (error) {
        res.json({ error });
