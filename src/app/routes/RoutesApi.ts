...
class RoutesApi {
  ...
  private transactionsRoutes(): Router {
    ...
    transactionsRoutes.get(
      "/statementResume",
      TransactionController.getStatementResume
    );
    transactionsRoutes.post(
      "/statementMonth",
      TransactionController.getStatementForMonth
    );
    ...
    transactionsRoutes.post(
      "/statementIncome",
      TransactionController.getIncomeForMonth
    );
    transactionsRoutes.post(
      "/statementExpense",
      TransactionController.getExpenseForMonth
    );
    transactionsRoutes.post(
      "/incomeProfit",
      TransactionController.getIncomeProfit
    );
    transactionsRoutes.post(
      "/expenseProfit",
      TransactionController.getExpenseProfit
    );
    ...
    transactionsRoutes.put(
      "/billsToPay/:id",
      TransactionController.updateBillsToPay
    );
    //billsToReceive
    transactionsRoutes.get(
      "/billsToReceive",
      TransactionController.billsToReceive
    );
    transactionsRoutes.put(
      "/billsToReceive/:id",
      TransactionController.updateBillsToReceive
    );
    //bills general
